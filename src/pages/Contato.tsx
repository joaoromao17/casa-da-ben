            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Av. Principal, 1234, Centro - Sua Cidade/UF</p>
                  <a 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">contato@casadabencao.org</p>
                  <p className="text-gray-600">secretaria@casadabencao.org</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Domingo: 9h e 18h</p>
                  <p className="text-gray-600">Quarta: 19h30</p>
                  <p className="text-gray-600 mt-2 font-medium">Secretaria:</p>
